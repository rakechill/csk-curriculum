...
os.system('cls' if os.name == 'nt' else 'clear')
part_1 = "Part 1: Choosing Your Dorm"
print(part_1)
...
os.system('cls' if os.name == 'nt' else 'clear')
part_2 = "Part 2: Choosing Your Roommate"
print(part_2)
input("Press any key to continue...")
os.system('cls' if os.name == 'nt' else 'clear')
...
os.system('cls' if os.name == 'nt' else 'clear')
part_6 = "Part 6: Going to Get Boba"
print(part_6)
input("Press any key to continue...")
os.system('cls' if os.name == 'nt' else 'clear')
...
os.system('cls' if os.name == 'nt' else 'clear')
part_8 = "Part 8: Going to Lecture"
print(part_8)
input("Press any key to continue...")
os.system('cls' if os.name == 'nt' else 'clear')
